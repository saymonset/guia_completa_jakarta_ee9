...
public class AplicacionListener implements ServletContextListener,
    ...
    //Manejar contexto general de la aplicacion: ServletContextListener,
    //Esto es solo para el request: ServletRequestListener
    //Solo para la session: HttpSessionListener
